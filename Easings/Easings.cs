...
static public class Easings
{
    ...
    public static Color Interpolate(Color a, Color b, float p, Functions function)
    {
        var t = Interpolate(p, function);
        var result = new Color(Mathf.Lerp(a.r, b.r, t), 
    ...
    public static Vector3 Interpolate(Vector3 a, Vector3 b, float p, Functions function)
    {
        float t = Interpolate(p, function);
        Vector3 result = new Vector3(Mathf.Lerp(a.x, b.x, t), 
                                        Mathf.Lerp(a.y, b.y, t), 
                                        Mathf.Lerp(a.z, b.z, t));
        return result;
    }

    public static Vector2 Interpolate(Vector2 a, Vector2 b, float p, Functions function)
    {
        float t = Interpolate(p, function);
        Vector2 result = new Vector2(Mathf.Lerp(a.x, b.x, t), Mathf.Lerp(a.y, b.y, t));
        return result;
    }

    public static float Interpolate(float a, float b, float p, Functions function)
    {
        float t = Interpolate(p, function);
        return Mathf.Lerp(a, b, t);
    }
    
    public static float Interpolate(int a, int b, float p, Functions function)
    {
        float t = Interpolate(p, function);
        return Mathf.Lerp(a, b, t);
    }
